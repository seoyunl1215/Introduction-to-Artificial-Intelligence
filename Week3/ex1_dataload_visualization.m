% clear: 작업공간의 변수를 모두 지워라 / close all: 그림이 떠 있다면 다
% 지워라 / clc: 명령창에 있는 것들을 다 지워라
clear; close all; clc; 
...
%% 각 종을 숫자로 표현 1: setosa, 2: versicolor, 3:virginia
spcs2num = [];
...
% 평가데이터. 51~70 versicolor, 121~150: virginica 총 40개
